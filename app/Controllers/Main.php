        ...
        switch ($mode) {
            ...
            case 'login': {
                $user_m = new \App\Models\UserAccount();
                    ...
                    $secretkey="6LfLxSYlAAAAABvTMaRqUP-E2EQWsRFMoGxRhHTq";
                    $url='https://www.google.com/recaptcha/api/siteverify?secret='.urldecode($secretkey).'&response='.urldecode($recaptcha).' ';
                    $recaptcha_data = [
                        'secret' => $secretkey,
                        'response' => $recaptcha,
                    ];
                    ...
                    $response = file_get_contents($url, false, $recaptcha_context);
